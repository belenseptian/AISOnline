    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="{{route('home')}}">IoAIS v1.0</a>
                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="{{route('actionlogout')}}"><i class="fas fa-power-off mr-2"></i>Log Out</a>
                                <a class="dropdown-item" href="{{ url('/') }}/public/admin/content/change-password"><i class="fas fa-key"></i> Change Password</a>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link" href="{{route('home')}}"><i class="fa fa-fw fa-user-circle"></i>Home <span class="badge badge-success">6</span></a>
                                ...
                                <div id="submenu-4" class="collapse submenu">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            ...
                                            <a class="nav-link" href="{{route('home')}}/live-cctv">Live Video<span class="badge badge-secondary">New</span></a>
                                        </li>
                                        <li class="nav-item">
